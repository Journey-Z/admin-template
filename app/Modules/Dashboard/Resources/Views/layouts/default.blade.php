...
<html xmlns="http://www.w3.org/1999/html">
  <head>
    ...
    <!-- custom css -->
    <link href="{{mix('assets/css/style.min.css')}}" rel="stylesheet" />
    <link href="{{mix('assets/css/application.min.css')}}" rel="stylesheet" />
  </head>
  <body class="hold-transition skin-blue sidebar-mini @if(isset($_COOKIE['sidebar-collapsed'])) sidebar-collapse @endif">
    <div class="wrapper">
      ...
      <div class="content-wrapper category" style="min-height: 800px;">
        @include('Dashboard::errors.flash')
        @yield('content')
      </div><!-- /.content-wrapper -->

      {{--Default Modal--}}
      <div class="modal fade" id="modal" role="basic" aria-hidden="true">
        <div class="modal-dialog" id="default-modal">
    ...
    <!-- application js  -->
    <script src="{{mix('assets/js/application.min.js')}}"></script>
    <!-- Select2 -->
    ...
    $(function () {
        ...
        $('.sidebar-toggle').click(function() {
          ...
          if (Boolean(localStorage.getItem("sidebar-collapsed"))) {
            ...
            setCookie('sidebar-collapsed','1',365);
          }
        });
